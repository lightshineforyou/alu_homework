...
module shifter_1bit (
    ...
    wire Nenable;
    not(Nenable,enable);
	wire[31:0] result00; //补0左移
	wire[31:0] result01; //循环左移
	wire[31:0] result10; //补0右移
	wire[31:0] result11; //循环右移
	wire[31:0] result000;   //是否移位
...
module shifter_32bit(
    input [31:0] In,
    input [1:0]dir, //00表示补0向左移,01表示循环向左移,10表示补0向右移,11表示循环向右移
    input [4:0] bite,
    output  [31:0] result
    );
    wire[31:0] temp[3:0];
