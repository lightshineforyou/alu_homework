...
//-----{调用ALU模块}begin
    ...
    reg  [63:0] alu_mul_result;   // ALU乘法结果
    ...
    begin
        case(display_number)
            ...
            begin
                display_valid <= 1'b1;
                display_name  <= "CONTR";
                display_value <={19'd0, alu_control};
            end
            6'd4 :
            begin
                display_valid <= 1'b1;
            ...
            begin
                display_valid <= 1'b1;
                display_name  <= "MULH";
                display_value <= alu_mul_result[63:32];
            end
            6'd6 :
            begin
                display_valid <= 1'b1;
                display_name  <= "MULL";
                display_value <= alu_mul_result[31:0];
            end
            default :
            begin
                display_valid <= 1'b0;
